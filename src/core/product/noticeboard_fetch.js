 ...
 */
export function noticeboard_fetch_1(req, res) {
  const { id } = req.body;
...
export function noticeboard_fetch_2(req, res) {
  const { id } = req.body;
  ...
  const n1_files = fs.readdirSync(path.resolve(__dirname, `../../../storage/n2/${id}`));
...
export function noticeboard_fetch_3(req, res) {
  const { id } = req.body;
  ...
  const n1_files = fs.readdirSync(path.resolve(__dirname, `../../../storage/n3/${id}`));
...
export function noticeboard_fetch_4(req, res) {
  const { id } = req.body;
  ...
  const n1_files = fs.readdirSync(path.resolve(__dirname, `../../../storage/n4/${id}`));
